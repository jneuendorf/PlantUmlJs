...
(function() {
  var JsUml, base64, heterarchy, isNode, plantUml, root, url,
  ...
  })(heterarchy.multi(root.namespace3.A, root.namespace4.A, root.namespace1.A));

  JsUml.setNamespaceGetter(function(namespace) {
    var dict, i, len, tuple;
    dict = [[root.namespace1, "namespace1"], [root.namespace2, "namespace2"], [root.namespace3, "namespace3"], [root.namespace4, "namespace4"]];
