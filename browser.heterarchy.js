...
(function() {
  var assert, copyOwn, every, exports, find, generate, head, hierarchy, inherited, isEmpty, isEqual, isJavaScriptClass, javaScriptClassNames, javaScriptClasses, map, memoize, merge, mro, partial, reduce, reject, reparent, some, tail, without,
    slice = [].slice,
  ...
  head = _.head, tail = _.tail, map = _.map, find = _.find, some = _.some, without = _.without, isEmpty = _.isEmpty, every = _.every, memoize = _.memoize, reject = _.reject, partial = _.partial, isEqual = _.isEqual, reduce = _.reduce;
  ...
  javaScriptClasses = reduce(javaScriptClassNames, function(classes, name) {
    classes[window[name]] = window[name];
    return classes;
  }, {});
